...
public class Center_2 extends SequentialCommandGroup {
  ...
  public Center_2(
    ...
    addCommands(
        AutoBuilder.resetOdom(path.Center_2.getStartingHolonomicPose().get()), 
        Commands.race(
          AutoBuilder.followPath(path.Center_2).withTimeout(0.05),
          shooter.runRPMCommand(3000).withTimeout(0.05)
        ), 
        Commands.race(
          AutoBuilder.followPath(path.Center_2), //go to depot
          Commands.sequence(
            intakePivot.goDown(), 

...
public class Center_3 extends SequentialCommandGroup {
  ...
  public Center_3(
    ...
    addCommands(
        AutoBuilder.resetOdom(path.Center_3.getStartingHolonomicPose().get()), 
        Commands.race(
          AutoBuilder.followPath(path.Center_3).withTimeout(0.05),
          shooter.runRPMCommand(3000).withTimeout(0.05)
        ), 
        Commands.race(
          AutoBuilder.followPath(path.Center_3), //go to depot
          Commands.sequence(
            intakePivot.goDown(), 
